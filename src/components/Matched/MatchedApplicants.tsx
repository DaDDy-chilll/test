        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <p>{applicant.personalInfo.location}</p>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <p>{applicant.personalInfo.birthdate}</p>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <p>{applicant.personalInfo.gender}</p>
            </div>
          </div>
        </div>
      </div>
...
<path d="M16 6H18V4H16V6ZM16 10H18V8H16V10ZM16 14H18V12H16V14ZM16 18V16H20V2H11V3.4L9 1.95V0H22V18H16ZM0 18V8L7 3L14 8V18H8V13H6V18H0ZM2 16H4V11H10V16H12V9L7 5.45L2 9V16Z" fill="#D04040"/>
</svg>
