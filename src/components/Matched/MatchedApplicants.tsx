...
const MatchedApplicants = ({ selectedApplicantId }: MatchProps) => {
  ...
  }, [selectedApplicantId, refetch, isSuccess]);

  if (isError || !applicant) {
    return <div>Error loading applicant data</div>;
  }
          ...
          <div className="flex flex-col gap-y-2">
            ...
            <div className="flex items-center gap-10">
              <div className="flex items-center gap-2">
                ...
                <p className="text-sm">{applicant.personalInfo.location}</p>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <p className="text-sm">{applicant.personalInfo.birthdate}</p>
              </div>

              <div className="flex items-center gap-2">
                {applicant.personalInfo.gender.toLowerCase() === "male" ? (
                  <svg
                    width="20"
                    height="20"
        ...
        <div className="grid grid-cols-5 ">
          <div className="col-span-2 flex flex-col gap-y-3 border-r-2 border-gray-500">
            ...
            <div className="grid grid-cols-2">
              ...
              <p className="text-sm text-end px-10">
                {applicant.jobsPreference.salary}
              </p>
            </div>
            ...
            <div className="grid grid-cols-2">
              ...
              <p className="text-sm text-end px-10">
                {applicant.jobsPreference.workingHours}
              </p>
            </div>
          ...
          <div className="col-span-3 pl-4">
            ...
            <div className="flex flex-col gap-y-3 mb-2">
              {applicant.education.map((edu: Education, index: number) => (
                <div
                  key={index}
