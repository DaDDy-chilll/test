...
const RedirectComponent = ({title,register=false,logIn=false,description}: Props) => {
...
<Button onClick={()=>{navigate(route)}} className="bg-white text-black w-60 font-semibold">{logIn?'Login Here':register?'Register Here':''}</Button>
    </div>
  )
}
