...
const Sidebar = () => {
  ...
  return (
    <aside
      id="logo-sidebar"
      className={`float-left md:fixed  top-0 text-white left-0 z-50 ${
        sideBar ? "w-64" : "w-20"
    ...
    >
      <div className="h-full px-3 pb-4 overflow-y-auto flex flex-col justify-between">
        <ul className="space-y-4 font-medium">
          <li className="w-full flex justify-center mb-7 items-center">
            <img
              src={logo}
              className={`${sideBar ? "w-20" : "w-20 mb-3"}`}
              alt="Japan job logo"
            />
          </li>
          <li>
            <NavLink
              ...
              className={`flex bg-gray-300 ${
                sideBar
                  ? "justify-start item-center p-2 pl-10"
                  : "justify-center p-2"
              } text-gray-900 rounded-lg dark:text-white  hover:text-white dark:hover:bg-gray-700 group`}
            >
          ...
          <li>
            ...
            >
              <div className="flex overflow-hidden">
                ...
                {sideBar && (
                  <span className="flex-1 ms-3 whitespace-nowrap overflow-hidden">
                    {jp.applicant}
                  </span>
                )}
              </div>
          ...
          <li>
            <NavLink
              ...
              className={({ isActive }) => `flex bg-gray-300 ${
                sideBar
                  ? "justify-start items-center p-2 pl-10"
                  : "justify-center p-2"
              } text-gray-900 rounded-lg dark:text-white hover:text-white dark:hover:bg-gray-700 group
              ${isActive ? "text-white bg-primaryColor" : ""}
              `}
            >
              {({ isActive }) => (
                <div className="flex overflow-hidden">
          ...
          <div
            ...
            className={`cursor-pointer flex ${
              sideBar
                ? "justify-start items-center p-2 pl-10"
                : "justify-center p-2"
            } bg-gray-300  text-gray-900 rounded-lg dark:text-white  hover:text-primaryColor dark:hover:bg-gray-700 group`}
          >
            <div className="flex overflow-hidden">
              <svg
                xmlns="http://www.w3.org/2000/svg"
