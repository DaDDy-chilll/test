...
const Sidebar = () => {
  ...
  return (
    <aside
      id="logo-sidebar"
      className={`fixed top-0 text-white left-0 z-40 ${sideBar ? 'w-64' : 'w-20'} h-screen pt-5 transition-all duration-500 ease-in-out border-r border-gray-300 bg-gray-50 md:translate-x-0`}
      aria-label="Sidebar"
    >
      <div className="h-full px-3 pb-4 overflow-y-auto flex flex-col justify-between">
        <ul className="space-y-4 font-medium">
          <li className="w-full flex justify-center mb-10 items-center">
            <img src={logo} className={`${sideBar ? 'w-20' : 'w-20 mb-3'}`} alt="Japan job logo" />
          </li>
          <li>
            <NavLink
              to={Routenames.DASHBOARD}
              className={`flex bg-gray-300 ${sideBar ? 'justify-start item-center p-2 pl-10' : 'justify-center p-2'} text-gray-900 rounded-lg dark:text-white  hover:text-white dark:hover:bg-gray-700 group`}
            >
              <div className="flex overflow-hidden">
                <svg
                  ...
                  className={`${sideBar ? 'relative top-1' : ''}`}
                >
                ...
                {sideBar && <span className="ms-3 whitespace-nowrap overflow-hidden">{jp.dashboard}</span>}
              </div>
            </NavLink>
          </li>
          ...
          <li>
            ...
            >
              <div className="flex overflow-hidden">
                ...
                {sideBar && <span className="flex-1 ms-3 whitespace-nowrap overflow-hidden">{jp.applicant}</span>}
              </div>
            </NavLink>
          </li>
          ...
          <li>
            ...
            >
              <div className="flex overflow-hidden">
                ...
                {sideBar && <span className="flex-1 ms-3 whitespace-nowrap overflow-hidden">{jp.matches}</span>}
              </div>
            </NavLink>
          </li>
          ...
          <li>
            ...
            >
              <div className="flex overflow-hidden">
                ...
                {sideBar && <span className="flex-1 ms-3 whitespace-nowrap overflow-hidden">{jp.chat}</span>}
              </div>
            </NavLink>
          </li>
            ...
            >
              <div className="flex overflow-hidden">
                <svg
                  ...
                  fill="currentColor"
                  xmlns="http://www.w3.org/2000/svg"
                  className={`${sideBar ? 'relative top-0.5' : ''}`}
                >
                  <path
                ...
                {sideBar && <span className="flex-1 ms-3 whitespace-nowrap overflow-hidden">{jp.joblists}</span>}
              </div>
            </NavLink>
          </li>
          ...
          <li>
            ...
            >
              <div className="flex overflow-hidden">
                ...
                {sideBar && <span className="flex-1 ms-3 whitespace-nowrap overflow-hidden">{jp.calendar}</span>}
              </div>
            </NavLink>
          </li>
          ...
          <li>
            ...
            >
              <div className="flex overflow-hidden">
                ...
                {sideBar && <span className="flex-1 ms-3 whitespace-nowrap overflow-hidden">{jp.profile}</span>}
              </div>
            </NavLink>
          </li>
        </ul>
        <div>
          <div
            onClick={onLogout}
            className={`cursor-pointer flex ${sideBar ? 'justify-start items-center p-2 pl-10' : 'justify-center p-2'} bg-gray-300  text-gray-900 rounded-lg dark:text-white  hover:text-primaryColor dark:hover:bg-gray-700 group`}
          >
            <div className="flex overflow-hidden">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              {sideBar && <span className="ms-3 whitespace-nowrap overflow-hidden">{jp.logout}</span>}
            </div>
          </div>
        </div>
      </div>
